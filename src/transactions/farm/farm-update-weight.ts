...
export async function processTx(data: FarmUpdateWeightData, sender: string, _transactionId: string): Promise<boolean> {
...
export async function processBatch(data: FarmBatchUpdateWeightsData, sender: string, _transactionId: string): Promise<boolean> {
